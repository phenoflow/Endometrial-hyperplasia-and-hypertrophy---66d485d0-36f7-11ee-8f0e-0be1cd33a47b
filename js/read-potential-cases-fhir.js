...
(async () => {
  ...
  await fs.writeFile("endometrial-hyperplasia-and-hypertrophy-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("endometrial-hyperplasia-and-hypertrophy-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
